...
import com.mcc.api.AnthropicClient
import com.mcc.api.AnthropicClient.StreamEvent
import com.mcc.data.ConfigManager
import com.mcc.data.ConversationManager
import com.mcc.model.Conversation
import com.mcc.model.Message
import com.mcc.ui.ChatListView
import com.mcc.ui.MessageInputView
import com.mcc.ui.SettingsView
import com.mcc.ui.SidebarView
...
class MainActivity : Activity() {
    ...
    private fun createTopBar(): LinearLayout {
        return LinearLayout(this).apply {
            ...
            // Hamburger button
            val hamburger = TextView(this@MainActivity).apply {
                text = "☰"
    ...
    private fun sendMessage(text: String) {
        ...
        convManager.addMessage(conv.id, userMsg)
        ...
        convManager.addMessage(conv.id, assistantMsg)
